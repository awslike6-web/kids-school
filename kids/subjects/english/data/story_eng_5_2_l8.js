  ...
  pages: [
    ...
    },
    {
      ...
      textHtml: `
        ...
        <div style="background: #f0fdf4; border-radius: 12px; padding: 12px 16px; margin-top: 12px; border: 1px solid #bbf7d0;">
          <div style="font-weight: bold; color: #166534; margin-bottom: 4px; font-size: 0.95rem;">💡 콕 집어보는 쉬운 단어</div>

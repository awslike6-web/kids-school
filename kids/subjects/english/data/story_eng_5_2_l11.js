// ========================================================
// 📖 Minsu Explores the Village (영어 5-2 11단원: Where Is the Library?) 데이터 모듈
// ========================================================
window.STORY_BOOK = {
  id: "english_5_2_l11",
  title: "Minsu Explores the Village (영어 5-2 11단원)",
  icon: "🧭",
  themeColor: "#10b981",
  themeColorDark: "#059669",
  backUrl: "english.html",
  backLabel: "🚪 영어방 대기실",
  version: "20260911_l11_v1",
  bilingual: true,
  imgBase: "https://raw.githubusercontent.com/awslike6-web/kids-archive/main/assets/storybook/english/minsu/5-2/11/",
  pages: [
    {
      page: 1,
      ...
      engAudio: "../../assets/audio/storybook/english_l11/eng_l8_p1.mp3",
      korAudio: "../../assets/audio/storybook/english_l11/kor_l8_p1.mp3",
      audio: "../../assets/audio/storybook/english_l11/eng_l8_p1.mp3",
      textHtml: `
        <div class="webtoon-passage" style="line-height: 1.8; text-align: center; padding: 10px 0;">
          ...
          <div style="background: rgba(15, 23, 42, 0.7); border-radius: 12px; padding: 14px; margin-bottom: 14px; text-align: left; border: 1.5px solid #334155;">
            <div style="font-size: 1.1rem; font-weight: bold; color: #34d399; margin-bottom: 4px;">
              Welcome to Lesson 11 storybook!
            </div>
            <div style="font-size: 0.98rem; color: #cbd5e1; margin-bottom: 10px;">
              초등학교 5학년 2학기 영어 11단원 동화에 온 것을 환영해요!
            </div>
            <div style="font-size: 1.1rem; font-weight: bold; color: #34d399; margin-bottom: 4px;">
        ...
        <div class="webtoon-ref-badge">📖 교과서 연계 : 초등 영어 5학년 2학기 11단원 (위치 묻고 길 안내하기)</div>
      `
    },
    {
      page: 2,
      ...
      engAudio: "../../assets/audio/storybook/english_l11/eng_l8_p2.mp3",
      korAudio: "../../assets/audio/storybook/english_l11/kor_l8_p2.mp3",
      audio: "../../assets/audio/storybook/english_l11/eng_l8_p2.mp3",
      textHtml: `
    ...
    },
    {
      ...
      engAudio: "../../assets/audio/storybook/english_l11/eng_l8_p3.mp3",
      korAudio: "../../assets/audio/storybook/english_l11/kor_l8_p3.mp3",
      audio: "../../assets/audio/storybook/english_l11/eng_l8_p3.mp3",
      textHtml: `
        <div class="webtoon-passage" style="line-height: 1.8;">
          <div style="font-size: 1.25rem; font-weight: bold; color: #f8fafc; margin-bottom: 4px;">
    ...
    },
    {
      ...
      engAudio: "../../assets/audio/storybook/english_l11/eng_l8_p4.mp3",
      korAudio: "../../assets/audio/storybook/english_l11/kor_l8_p4.mp3",
      audio: "../../assets/audio/storybook/english_l11/eng_l8_p4.mp3",
      textHtml: `
        <div class="webtoon-passage" style="line-height: 1.8;">
          <div style="font-size: 1.25rem; font-weight: bold; color: #f8fafc; margin-bottom: 4px;">
    ...
    },
    {
      ...
      engAudio: "../../assets/audio/storybook/english_l11/eng_l8_p5.mp3",
      korAudio: "../../assets/audio/storybook/english_l11/kor_l8_p5.mp3",
      audio: "../../assets/audio/storybook/english_l11/eng_l8_p5.mp3",
      textHtml: `
        <div class="webtoon-passage" style="line-height: 1.8;">
          <div style="font-size: 1.25rem; font-weight: bold; color: #f8fafc; margin-bottom: 4px;">
